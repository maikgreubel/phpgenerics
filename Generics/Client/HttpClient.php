 ...
 * Import dependencies
 */
require_once 'Generics/Streams/HttpStream.php';
...
require_once 'Generics/Client/HttpStatus.php';
require_once 'Generics/Client/HttpException.php';
...
class HttpClient extends ClientSocket implements HttpStream
{
  ...
  public function request($requestType)
  {
    ...
    $ms->interpolate ( "Host: {host}\r\n", array (
        'host' => $this->getEndpoint ()->getAddress () 
    ) );
