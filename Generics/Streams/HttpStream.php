...
interface HttpStream extends InputOutputStream
{
   ...
   * 
   * @param string $headerName  The header to set
   * @param string $headerValue The value to set
   */
   ...
   * 
   * @param InputStream $payload The payload to append
   * 
   * @throws \Generics\Streams\StreamException
   */
   ...
   * Start the request
   * 
   * @param string $requestType The type of request (GET, POST, etc.)
   * 
